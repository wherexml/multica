...
1. Open http://localhost:22202 — log in with any email + code **`888888`**
...
Open http://localhost:22202. Enter any email address and use verification code **`888888`** to log in.
...
1. Open your workspace at http://localhost:22202
